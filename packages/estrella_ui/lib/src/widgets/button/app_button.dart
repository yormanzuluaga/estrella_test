...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final textStyle = _textStyle ?? UITextStyle.labels.label.copyWith(color: _colorTitle);
    ...
    return ElevatedButton(
      ...
      child: Row(
        ...
        children: [
          Visibility(
            visible: icon != null,
            child: Padding(padding: const EdgeInsets.only(right: AppSpacing.sm), child: Icon(icon, color: _colorTitle)),
          ),
